...
import UpdateForm from '@/component/updateinfor';
    ...
    const handelSubmitForm = async () => {
        ...
        try {
            const response = await fetch(
                'http://localhost:3000/api/users/insertInfo',
                {
                    method: 'POST',
                    headers: {
                ...
                <div className={style.wrapper}>
                    <div className={style.container}>
                        ...
                        <div className={style.content}>
                            ...
                            <UpdateForm ref_form={form} user={null} />{' '}
                    ...
                    <div
                        ...
                        onAnimationEnd={() => {
                            router.push(
                                sessionStorage.getItem('curentpage2') ||
                                    '/profile?tab=hoso',
                            );
